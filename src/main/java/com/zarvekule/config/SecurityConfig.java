package com.zarvekule.config;

import com.zarvekule.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/homebrews/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/homebrew-comments/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/homebrew-comments").authenticated()
                        .requestMatchers(HttpMethod.DELETE, "/api/homebrew-comments/**").authenticated()
                        .requestMatchers(HttpMethod.PATCH, "/api/homebrew-comments/**").hasAnyAuthority("ROLE_MODERATOR", "ROLE_ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/wiki/**").permitAll()
